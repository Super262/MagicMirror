...
public final class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public final void setDelegate(QiluDelegate delegate) {
        this.mDelegate = delegate;
    }

    public final void onCropTarget(Uri uri) {
        createNewImageView(uri);
    ...
    private void createNewImageView(Uri uri) {
        final File photo=new File(uri.getPath());
        photoList.add(photo);
        ...
        mTargetImageVew.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTargetDialog.show();
                final Window window;
                window = mTargetDialog.getWindow();
                if (window != null) {
    ...
    private void initAddIcon() {
        ...
        mIconAdd.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mDelegate.startCameraWithCheck(3000,3000);
            }
        });
